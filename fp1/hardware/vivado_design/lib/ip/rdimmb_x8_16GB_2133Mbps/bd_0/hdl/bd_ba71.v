...
//Date        : Mon Aug 27 17:35:47 2018
//Host        : ecs-c897.novalocal running 64-bit CentOS Linux release 7.3.1611 (Core)
//Command     : generate_target bd_ba71.bd
//Design      : bd_ba71
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_ba71,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_ba71,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "rdimmb_x8_16GB_2133Mbps_microblaze_mcs.hwdef" *) 
module bd_ba71
   (Clk,
    IO_addr_strobe,
    IO_address,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_ba71 lmb_bram_I bd_ba71 second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_ba71_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_ba71_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_ba71_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_ba71_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_ba71 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_ba71_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_ba71_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_ba71_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_ba71_second_lmb_bram_I_0 second_lmb_bram_I
