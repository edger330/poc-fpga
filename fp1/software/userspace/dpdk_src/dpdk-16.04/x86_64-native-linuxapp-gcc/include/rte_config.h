...
#undef RTE_LIBRTE_MCGA_PMD
#undef RTE_LIBRTE_MCGA_DEBUG_INIT
#undef RTE_LIBRTE_MCGA_DEBUG_RX
#undef RTE_LIBRTE_MCGA_DEBUG_TX
#undef RTE_LIBRTE_MCGA_DEBUG_DRIVER
#undef RTE_LIBRTE_MCGA_MAP_DMA
#undef RTE_LIBRTE_ACC_PMD
#define RTE_LIBRTE_ACC_PMD 1
#undef RTE_LIBRTE_ACC_DEBUG_INIT
#define RTE_LIBRTE_ACC_DEBUG_INIT 1
#undef RTE_LIBRTE_ACC_DEBUG_RX
#define RTE_LIBRTE_ACC_DEBUG_RX 1
#undef RTE_LIBRTE_ACC_DEBUG_TX
#define RTE_LIBRTE_ACC_DEBUG_TX 1
#undef RTE_LIBRTE_ACC_DEBUG_DRIVER
#define RTE_LIBRTE_ACC_DEBUG_DRIVER 1
